...
```{r}
dat  %>%  ggplot(aes(x=EngDispl, y=FE)) + geom_point() + geom_hline(yintercept = naive_guess, color="red") + stat_smooth(method="lm", se=FALSE) 
```
...
y.2011 <- predict(lm(FE ~ EngDispl, data = cars2011), data = cars2011)
y.2012 <- predict(lm(FE ~ EngDispl, data = cars2012), data = cars2012)

rmse.2010 <- rmse(cars2010$FE, y.2010)
rmse.2011 <- rmse(cars2011$FE, y.2011)
rmse.2012 <- rmse(cars2012$FE, y.2012) 

qplot(x=cars2010$FE, y=y.2010) + stat_smooth(method="lm", se=FALSE)
qplot(x=cars2011$FE, y=y.2011) + stat_smooth(method="lm", se=FALSE)
qplot(x=cars2012$FE, y=y.2012) + stat_smooth(method="lm", se=FALSE)
...
fit.2010 <- lm(FE ~ EngDispl + NumCyl + VarValveLift, data = cars2011)
